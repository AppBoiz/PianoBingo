/**
 * ⚠️ DEPRECATED: This manual service worker is NO LONGER USED in production.
 * 
 * Production builds use the Workbox-generated service worker at dist/service-worker.js
 * created by scripts/generate-workbox-sw.js during the build process.
 * 
 * This file is kept only for reference and will be removed once the React
 * migration is complete and the legacy surface is retired.
 * 
 * Do NOT edit this file - changes will not affect production behavior.
 */
