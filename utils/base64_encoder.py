...
pdf_file_path = os.path.join(script_dir, "../resources/pdf/introdutione-seconda.pdf") 
# Path to output the Base64 encoded data
output_file_path = os.path.join(script_dir,  "../resources/base64/introdutione-seconda.js") 
